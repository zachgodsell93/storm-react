    ...
    return (
        <svg className={className} width="373px" height="80px" viewBox="0 0 373 80" version="1.1" >
            ...
            <g id="🙋‍♂️-Punters" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <path d="M326.961061,79.999797 L0,80 L0,0 L372.767802,-0.00333351626 C351.443865,22.1663214 335.480006,49.528977 326.961061,79.999797 Z" id="Left-1" fill="#FFFFFF"></path>
            </g>
        </svg>
    )
}
...
export const LeftTwo = ({className}) => {
    return (
        <svg className={className} width="326px" height="80px" viewBox="0 0 326 80" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <title>Left 2</title>
            <g id="🙋‍♂️-Punters" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <path d="M320,36 C320,51.1498461 321.782504,65.8833663 325.149226,80.002275 L0,80 L0,2.84217094e-13 L323.424953,-0.00265823222 C321.17712,11.6523577 320,23.6887132 320,36 Z" id="Left-2" fill="#FFFFFF"></path>
            </g>
        </svg>
    )
}
...
export const LeftThree = ({className}) => {
    return (
        <svg className={className} width="381px" height="81px" viewBox="0 0 381 81" version="1.1" xmlns="http://www.w3.org/2000/svg" >
            <title>Left 3</title>
            <g id="🙋‍♂️-Punters" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <path d="M380.940964,80.0045149 L9.09494702e-13,80 L9.09494702e-13,0 L329.391878,0.00217851612 C339.559699,30.9725221 357.514595,58.4118345 380.940964,80.0045149 Z" id="Left-3" fill="#FFFFFF"></path>
            </g>
        </svg>
    )
}
    ...
    return (
        <svg className={className} width="373px" height="81px" fill="#000"  viewBox="0 0 373 81" version="1.1" xmlns="http://www.w3.org/2000/svg" >
            ...
            <g id="🙋‍♂️-Punters" stroke="none"  stroke-width="1">
                <path d="M326.961758,80.0038546 L0.000696480023,80.0040576 L0.000696480023,0.0040576152 L372.768498,0.000724098933 C351.444561,22.170379 335.480702,49.5330346 326.961758,80.0038546 Z" id="Right-1" fill="#FFFFFF" transform="translate(186.384597, 40.002391) scale(-1, 1) translate(-186.384597, -40.002391) "></path>
            </g>
        </svg>
    )
}
...
export const RightTwo = ({className}) => {
    return (
        <svg className={className} width="326px" height="81px" viewBox="0 0 326 81" version="1.1" xmlns="http://www.w3.org/2000/svg" >
            <title>Right 2</title>
            <g id="🙋‍♂️-Punters" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <path d="M319.999884,36.0026582 C319.999884,51.1525044 321.782388,65.8860245 325.14911,80.0049333 L-0.000115932664,80.0026582 L-0.000115932664,0.00265823222 L323.424837,-8.99918414e-15 C321.177004,11.6550159 319.999884,23.6913715 319.999884,36.0026582 Z" id="Right-2" fill="#FFFFFF" transform="translate(162.574497, 40.002467) scale(-1, 1) translate(-162.574497, -40.002467) "></path>
            </g>
        </svg>
    )
}
